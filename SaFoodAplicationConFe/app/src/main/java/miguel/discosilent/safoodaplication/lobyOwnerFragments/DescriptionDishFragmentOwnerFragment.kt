...
class DescriptionDishFragmentOwnerFragment : Fragment() {
    companion object {
        fun newInstance(name: String, image: String, category: String, description: String): DescriptionDishFragmentOwnerFragment {
            val fragment = DescriptionDishFragmentOwnerFragment()
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_description_dish_owner, container, false)
    }
